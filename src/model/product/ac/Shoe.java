...
public class Shoe extends Product implements Serializable {
    public Shoe() {
        super();
    }

    public Shoe(int id, String name, int size, int quantity, TradeMark tradeMark, double price, String describe) {
